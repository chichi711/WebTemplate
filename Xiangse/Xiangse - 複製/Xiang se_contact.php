    ...
    <div class="container content">
        <div class="row">
            ...
            <div class="col-12 col-md-9 cot1 cot3">
                ...
                <form class="form-horizontal" action="Xiang se_contact_0.php" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="x_name" name="x_name" type="text" class="form-control input-md">
                        ...
                        <div class="form-group">
                          ...
                          <input type="radio" name="pip" id="route-0" value="1" checked="checked">
                          親友介紹
                        </label>
                                <label class="radio-inline" for="route-1">
                          <input type="radio" name="pip" id="route-1" value="2">
                          網路資訊
                        </label>
                                <label class="radio-inline" for="route-2">
                          <input type="radio" name="pip" id="route-2" value="3">
                          經過看到
                        </label>
                                <label class="radio-inline" for="route-3">
                          <input type="radio" name="pip" id="route-3" value="4">
                          其他管道
                        </label>
                            </div>
                        </div>
